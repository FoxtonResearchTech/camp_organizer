...
import '../../../bloc/Profile/finance_profile_bloc.dart';
import '../../../bloc/Profile/finance_profile_event.dart';
import '../../../bloc/Profile/finance_profile_state.dart';

import '../../../utils/app_colors.dart';

class FinanceProfile extends StatefulWidget {
  @override
  _FinanceProfile createState() => _FinanceProfile();
}

class _FinanceProfile extends State<FinanceProfile>
    with TickerProviderStateMixin {
  late AnimationController _controller;
  late Animation<Offset> _slideAnimation;
  late FinanceProfileBloc _FinanceProfileBloc;
  ...
  void initState() {
    ...
    _FinanceProfileBloc = FinanceProfileBloc()..add(FetchDataEvent());
  }
            ...
            AnimatedPadding(
              ...
              child: BlocBuilder<FinanceProfileBloc, FinanceProfileState>(
                builder: (context, state) {
                  ...
                  } else if (state is FinanceProfileError) {
                    return Center(
                      child: Text(
