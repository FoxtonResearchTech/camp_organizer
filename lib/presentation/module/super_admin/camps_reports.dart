...
import 'selected_employee_commutative_report.dart';

class SuperAdminCampsReportsPage extends StatefulWidget {
  final String name;
  ...
  @override
  _SuperAdminCampsReportsPage createState() => _SuperAdminCampsReportsPage();
}
                  ...
                  if (selectedEmployee != null && reportType != null) {
                    ...
                    if (reportType == 'Individual') {
                      ...
                      Navigator.push(
                        ...
                        MaterialPageRoute(
                          builder: (context) =>
                              SuperAdminSelectedEmployeeCommutativeReport(
                            name: widget.name,
