...
class CampInchargeProfile extends StatefulWidget {
  const CampInchargeProfile({super.key});

  @override
  State<CampInchargeProfile> createState() => _CampInchargeProfileState();
}

class _CampInchargeProfileState extends State<CampInchargeProfile> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text(
          'Camp Incharge Profile',
          style: TextStyle(
