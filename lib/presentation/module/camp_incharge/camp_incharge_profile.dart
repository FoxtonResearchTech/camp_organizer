...
import '../../../bloc/Profile/camp_incharge_profile_bloc.dart';
import '../../../bloc/Profile/camp_incharge_profile_event.dart';
import '../../../bloc/Profile/camp_incharge_profile_state.dart';

import '../../../utils/app_colors.dart';

class CampInchargeProfile extends StatefulWidget {
  @override
  _CampInchargeProfile createState() => _CampInchargeProfile();
}

class _CampInchargeProfile extends State<CampInchargeProfile>
    with TickerProviderStateMixin {
  late AnimationController _controller;
  late Animation<Offset> _slideAnimation;
  late CampInChargeProfileBloc _CampInChargeProfileBloc;
  ...
  void initState() {
    ...
    _CampInChargeProfileBloc = CampInChargeProfileBloc()..add(FetchDataEvent());
  }
        ...
        body: Stack(
          children: [
            ...
            AnimatedPadding(
              ...
              child: BlocBuilder<CampInChargeProfileBloc,
                  CampInChargeProfileState>(
                builder: (context, state) {
                  if (state is CampInChargeProfileLoading) {
                    return const Center(child: CircularProgressIndicator());
                  } else if (state is CampInChargeProfileLoaded) {
