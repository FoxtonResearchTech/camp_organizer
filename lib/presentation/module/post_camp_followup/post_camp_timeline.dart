...
class _PostCampTimelineState extends State<PostCampTimeline> with SingleTickerProviderStateMixin{
                                          ...
                                          child: ElevatedButton(
                                            onPressed: () {
                                              ...
                                              Navigator.push(
                                                context,
                                                MaterialPageRoute(
                                                  builder: (context) => PostCampFollow(
                                            ...
                                            style: ElevatedButton.styleFrom(
                                              backgroundColor: Colors.indigo, // Stylish indigo color for "Follow Report"
                                              elevation: 5,
                                            ...
                                            child: Row(
                                              ...
                                              children: const [
                                                Icon(Icons.follow_the_signs, color: Colors.white), // Follow icon
                                                SizedBox(width: 8),
                                                Text(
                                                  'Follow Report',
                                                  style: TextStyle(
                                          ...
                                          child: ElevatedButton(
                                            onPressed: () {
                                              ...
                                              Navigator.push(
                                                context,
                                                MaterialPageRoute(
                                                  builder: (context) => PostCampFollowCompleted(
                                                    documentId: documentId,
                                                    campData: camp,
                                                  ),
                                                ),
                                            ...
                                            style: ElevatedButton.styleFrom(
                                              backgroundColor: Colors.teal, // Teal color for "View Report"
                                              elevation: 5,
                                              shape: RoundedRectangleBorder(
                                                borderRadius: BorderRadius.circular(20), // Rounded corners
                                              ),
