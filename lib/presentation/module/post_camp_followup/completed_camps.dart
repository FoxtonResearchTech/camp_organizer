...
class PostCampCompletion extends StatefulWidget {
  const PostCampCompletion({super.key});

  @override
  State<PostCampCompletion> createState() => _PostCampCompletionState();
}

class _PostCampCompletionState extends State<PostCampCompletion>
            ...
            builder: (context, state) {
              if (state is AdminApprovalLoading) {
                ...
                final waitingCamps = camps
                    .where((camp) => camp['campStatus'] == 'Completed')
                    .toList();
                      ...
                      : ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            return GestureDetector(
                              ...
                              child: camps[index]['campStatus'] == "Completed"
                                  ? Column(
                                      crossAxisAlignment:
