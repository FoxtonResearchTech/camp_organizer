...
class _OnsiteTeamSetupState extends State<OnsiteTeamSetup> {
  ...
  final TextEditingController opticalIncharge1Controller =
      TextEditingController();
  final TextEditingController opticalIncharge2Controller =
      TextEditingController();
  ...
  void initState() {
    ...
    dateController.text =
        widget.campData['campDate'] ?? ''; // if no value, set empty string
